...
public class BossDeathScript2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Destroy(GameObject.FindGameObjectWithTag("BossBullet2"));
            Destroy(GameObject.FindGameObjectWithTag("Boss2SkillBullet"));
